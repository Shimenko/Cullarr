...
ActiveRecord::Schema[8.1].define(version: 2026_03_14_120000) do
  ...
  create_table "arr_tags", force: :cascade do |t|
    t.bigint "arr_tag_id", null: false
    t.datetime "created_at", null: false
    t.integer "integration_id", null: false
    t.string "name", null: false
    t.datetime "updated_at", null: false
    t.index ["integration_id", "arr_tag_id"], name: "index_arr_tags_on_integration_id_and_arr_tag_id", unique: true
    t.index ["integration_id", "name"], name: "index_arr_tags_on_integration_id_and_name", unique: true
  ...
  create_table "deletion_actions", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.index ["deletion_run_id", "media_file_id"], name: "index_deletion_actions_on_deletion_run_id_and_media_file_id", unique: true
    ...
    t.index ["integration_id", "idempotency_key"], name: "index_deletion_actions_on_integration_id_and_idempotency_key", unique: true
  ...
  create_table "episodes", force: :cascade do |t|
    ...
    t.bigint "sonarr_episode_id", null: false
    t.string "title"
    t.bigint "tmdb_id"
    t.bigint "tvdb_id"
    t.datetime "updated_at", null: false
    ...
    t.index ["integration_id", "sonarr_episode_id"], name: "index_episodes_on_integration_id_and_sonarr_episode_id", unique: true
    ...
    t.index ["season_id", "episode_number"], name: "index_episodes_on_season_id_and_episode_number"
    t.index ["season_id"], name: "index_episodes_on_season_id"
    t.index ["tmdb_id"], name: "index_episodes_on_tmdb_id"
    t.index ["tvdb_id"], name: "index_episodes_on_tvdb_id"
    t.check_constraint "mapping_status_code::text = ANY (ARRAY['verified_path'::character varying, 'verified_external_ids'::character varying, 'verified_tv_structure'::character varying, 'provisional_title_year'::character varying, 'external_source_not_managed'::character varying, 'unresolved'::character varying, 'ambiguous_conflict'::character varying]::text[])", name: "episodes_mapping_status_code_v2_check"
  end
  ...
  create_table "keep_markers", force: :cascade do |t|
    ...
    t.text "note"
    t.datetime "updated_at", null: false
    t.index ["keepable_type", "keepable_id"], name: "index_keep_markers_on_keepable"
    t.index ["keepable_type", "keepable_id"], name: "index_keep_markers_on_keepable_type_and_keepable_id", unique: true
  end

  create_table "media_files", force: :cascade do |t|
    t.bigint "arr_file_id", null: false
    ...
    t.index ["integration_id", "arr_file_id"], name: "index_media_files_on_integration_id_and_arr_file_id", unique: true
  ...
  create_table "movies", force: :cascade do |t|
    ...
    t.string "plex_guid"
    t.string "plex_rating_key"
    t.bigint "radarr_movie_id", null: false
    t.string "title", null: false
    t.bigint "tmdb_id"
    t.datetime "updated_at", null: false
    t.integer "year"
    t.index ["imdb_id"], name: "index_movies_on_imdb_id"
    t.index ["integration_id", "radarr_movie_id"], name: "index_movies_on_integration_id_and_radarr_movie_id", unique: true
    ...
    t.index ["title", "year"], name: "index_movies_on_title_and_year"
    t.index ["tmdb_id"], name: "index_movies_on_tmdb_id"
    t.check_constraint "mapping_status_code::text = ANY (ARRAY['verified_path'::character varying, 'verified_external_ids'::character varying, 'verified_tv_structure'::character varying, 'provisional_title_year'::character varying, 'external_source_not_managed'::character varying, 'unresolved'::character varying, 'ambiguous_conflict'::character varying]::text[])", name: "movies_mapping_status_code_v2_check"
  end
  ...
  create_table "path_mappings", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.index ["integration_id", "from_prefix", "to_prefix"], name: "idx_on_integration_id_from_prefix_to_prefix_852ff14293", unique: true
  ...
  create_table "plex_users", force: :cascade do |t|
    ...
    t.bigint "tautulli_user_id", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "saved_views", force: :cascade do |t|
    ...
    t.check_constraint "scope::text = ANY (ARRAY['movie'::character varying, 'tv_show'::character varying, 'tv_season'::character varying, 'tv_episode'::character varying]::text[])", name: "saved_views_scope_check"
  end
  ...
  create_table "seasons", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.index ["series_id", "season_number"], name: "index_seasons_on_series_id_and_season_number", unique: true
  ...
  create_table "series", force: :cascade do |t|
    ...
    t.string "plex_guid"
    t.string "plex_rating_key"
    t.bigint "sonarr_series_id", null: false
    t.string "title", null: false
    t.bigint "tmdb_id"
    t.bigint "tvdb_id"
    t.datetime "updated_at", null: false
    t.integer "year"
    t.index ["imdb_id"], name: "index_series_on_imdb_id"
    t.index ["integration_id", "sonarr_series_id"], name: "index_series_on_integration_id_and_sonarr_series_id", unique: true
    t.index ["integration_id"], name: "index_series_on_integration_id"
    t.index ["plex_rating_key"], name: "index_series_on_plex_rating_key"
    t.index ["title", "year"], name: "index_series_on_title_and_year"
  ...
  create_table "watch_stats", force: :cascade do |t|
    ...
    t.bigint "max_view_offset_ms", default: 0, null: false
    ...
    t.index ["plex_user_id", "watchable_type", "watchable_id"], name: "idx_on_plex_user_id_watchable_type_watchable_id_55200a16f6", unique: true
    t.index ["plex_user_id"], name: "index_watch_stats_on_plex_user_id"
    t.index ["watchable_type", "watchable_id"], name: "index_watch_stats_on_watchable"
  end
